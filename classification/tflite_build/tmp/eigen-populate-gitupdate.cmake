...
execute_process(
  COMMAND "/usr/bin/git" show-ref "3460f3558e7b469efb8a225894e21929c8c77629"
  WORKING_DIRECTORY "/home/calista/School/frame-of-knowledge/classification/tflite_build/eigen"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "3460f3558e7b469efb8a225894e21929c8c77629")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("3460f3558e7b469efb8a225894e21929c8c77629" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/3460f3558e7b469efb8a225894e21929c8c77629")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/calista/School/frame-of-knowledge/classification/tflite_build/eigen'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/calista/School/frame-of-knowledge/classification/tflite_build/eigen'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
